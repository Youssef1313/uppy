...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e3.byteLength}`), e3.tiff && await e3.ensureChunk(this.ifd0Offset, o2(this.options));
  ...
  var _getPostResponseFunc = /* @__PURE__ */ _classPrivateFieldLooseKey8("getPostResponseFunc");
  var _getUrl = /* @__PURE__ */ _classPrivateFieldLooseKey8("getUrl");
  var _errorHandler = /* @__PURE__ */ _classPrivateFieldLooseKey8("errorHandler");
  ...
  var RequestClient = class {
    ...
    preflight(path) {
      ...
      return fetch(_classPrivateFieldLooseBase8(this, _getUrl)[_getUrl](path), {
        method: "OPTIONS"
      }).then((response) => {
    ...
    get(path, skipPostResponse) {
      const method = "get";
      return this.preflightAndHeaders(path).then((headers) => fetchWithNetworkError(_classPrivateFieldLooseBase8(this, _getUrl)[_getUrl](path), {
        method,
        headers,
        credentials: this.opts.companionCookiesRule || "same-origin"
      })).then(_classPrivateFieldLooseBase8(this, _getPostResponseFunc)[_getPostResponseFunc](skipPostResponse)).then(handleJSONResponse).catch(_classPrivateFieldLooseBase8(this, _errorHandler)[_errorHandler](method, path));
    }
  ...
  function _errorHandler2(method, path) {
    return (err) => {
      ...
      if (!((_err = err) != null && _err.isAuthError)) {
        err = new ErrorWithCause_default(`Could not ${method} ${_classPrivateFieldLooseBase8(this, _getUrl)[_getUrl](path)}`, {
          cause: err
        });
      }
