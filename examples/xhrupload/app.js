...
Uppy plugins must have unique \`id\` options. See https://uppy.io/docs/plugins/#id.`;
  ...
  var _getPostResponseFunc = /* @__PURE__ */ _classPrivateFieldLooseKey5("getPostResponseFunc");
  var _getUrl = /* @__PURE__ */ _classPrivateFieldLooseKey5("getUrl");
  var _errorHandler = /* @__PURE__ */ _classPrivateFieldLooseKey5("errorHandler");
  ...
  var RequestClient = class {
    ...
    preflight(path) {
      ...
      return fetch(_classPrivateFieldLooseBase5(this, _getUrl)[_getUrl](path), {
        method: "OPTIONS"
      }).then((response) => {
    ...
    get(path, skipPostResponse) {
      const method = "get";
      return this.preflightAndHeaders(path).then((headers) => fetchWithNetworkError(_classPrivateFieldLooseBase5(this, _getUrl)[_getUrl](path), {
        method,
        headers,
        credentials: this.opts.companionCookiesRule || "same-origin"
      })).then(_classPrivateFieldLooseBase5(this, _getPostResponseFunc)[_getPostResponseFunc](skipPostResponse)).then(handleJSONResponse).catch(_classPrivateFieldLooseBase5(this, _errorHandler)[_errorHandler](method, path));
    }
  ...
  function _errorHandler2(method, path) {
    return (err) => {
      ...
      if (!((_err = err) != null && _err.isAuthError)) {
        err = new ErrorWithCause_default(`Could not ${method} ${_classPrivateFieldLooseBase5(this, _getUrl)[_getUrl](path)}`, {
          cause: err
        });
      }
